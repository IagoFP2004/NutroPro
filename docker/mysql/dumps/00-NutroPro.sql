...
(7, 'BCAA 2:1:1 Limon', 'Aminoácidos ramificados para recuperación muscular. Sabor limón refrescante.', 24.99, 220, 2, 0, 'img_690dc2c9d71905.33666523.png', 8, 2, 0, NULL, NULL, NULL),
...
(9, 'Barritas Proteicas Chocolate', 'Pack de 12 barritas con 20g de proteína cada una. Sabor chocolate intenso.', 24.99, 150, 3, 1, 'img_6911dd43622e58.02477395.png', 19, 17, 8, NULL, NULL, NULL),
(11, 'Mantequilla de Cacahuete', 'Mantequilla 100% natural sin azúcares añadidos. Rica en proteínas y grasas saludables.', 8.99, 180, 3, 1, 'img_6911de496c8348.84448514.png', 25, 15, 50, NULL, NULL, NULL),
(14, 'Mallas Deportivas Mujer', 'Mallas de compresión con cintura alta. Diseño ergonómico y gran comodidad.', 34.99, 80, 4, 1, 'img_690da63d436116.53574100.png', NULL, NULL, NULL, 'L', 'Azul Marino', 'Nylon 80% Spandex 20%'),
(15, 'Pantalón Jogger Hombre', 'Pantalón deportivo con ajuste cómodo y bolsillos. Ideal para gimnasio o casual.', 39.99, 60, 4, 1, 'img_690da8059da7e6.07791865.png', NULL, NULL, NULL, 'XL', 'Gris', 'Algodón 70% Poliéster 30%'),
(16, 'Sudadera con Capucha', 'Sudadera térmica perfecta para calentamiento. Con capucha ajustable y bolsillo canguro.', 44.99, 50, 4, 1, 'img_690da8381bf3e9.34129226.png', NULL, NULL, NULL, 'L', 'Negro', 'Algodón 80% Poliéster 20%'),
(17, 'Top Deportivo Mujer', 'Sujetador deportivo de alto impacto con soporte reforzado. Transpirable y cómodo.', 29.99, 70, 4, 1, 'img_690da8b928d029.44521031.png', NULL, NULL, NULL, 'M', 'Rosa', 'Poliamida 85% Elastano 15%'),
(19, 'Shaker Profesional 700ml', 'Mezclador de proteínas con bola mezcladora y compartimento para suplementos. Libre de BPA.', 9.99, 250, 5, 1, 'img_6911de9894ca67.42207598.png', NULL, NULL, NULL, NULL, NULL, NULL),
(21, 'Banda Elástica Resistencia', 'Set de 5 bandas de resistencia con diferentes niveles. Incluye anclajes y bolsa de transporte.', 19.99, 150, 5, 0, 'img_6911d7f2c53ba7.34943804.png', NULL, NULL, NULL, NULL, NULL, NULL),
(22, 'Botella de Agua 1L', 'Botella deportiva con marcador de hidratación. Aislada térmicamente, mantiene frío 24h.', 7.99, 200, 5, 1, 'img_6911d88bac5414.45756341.png', NULL, NULL, NULL, NULL, NULL, NULL),
(23, 'Toalla Microfibra', 'Toalla ultra absorbente y de secado rápido. Perfecta para el gimnasio. 80x40cm.', 12.99, 180, 5, 1, 'img_6911d938b462c7.01619772.png', NULL, NULL, NULL, NULL, NULL, NULL),
...
(28, 'Whey Protein Isolate', 'Nuestra proteína aislada de mas alta calidad, la mejor calidad pir el mejor precio', 35.99, 200, 1, 0, 'img_690cb93ab7f069.16290636.png', 30, 20, 9, NULL, NULL, NULL),
(29, 'Proteina de Caseina', 'La Caseina es un semejante de la Whey Protein pero de digestion mas rapida, obtener una alta cantidad de proteina nunca ha sido tan facil, y menos con tan alta calidad', 24.99, 250, 1, 1, 'img_690cbd2b5be454.96145412.png', 25, 10, 7, NULL, NULL, NULL),
...
(33, 'Creatina Monohidratada sabor Fresa', 'Creatina monohidratada sabor fresa con un toque fresco y potente la mejor manera de aumentar tu productividad de la manera mas dulce y afrutada', 17.99, 300, 1, 1, 'img_690cc45d731e23.90917573.png', 5, 10, 5, NULL, NULL, NULL),
...
(38, 'Camiseta deportiva transpirable Gris', 'Camiseta deportiva de NutroPro transpirable, la mejor opcion para deportes de cardio dado que en ningun momento sentirar que estás mojda o encharcado', 14.99, 350, 4, 0, 'img_690db0c1814cd8.95938909.png', NULL, NULL, NULL, 'L', 'Gris', 'Malla'),
(39, 'Camiseta deportiva transpirable Rosa', 'Camiseta deportiva de NutroPro transpirable, la mejor opcion para deportes de cardio dado que en ningun momento sentirar que estás mojda o encharcado', 14.99, 350, 4, 0, 'img_690db13c4755f4.23768791.png', NULL, NULL, NULL, 'L', 'Rosa', 'Malla'),
(40, 'Camiseta deportiva transpirable Negro', 'Camiseta deportiva de NutroPro transpirable, la mejor opcion para deportes de cardio dado que en ningun momento sentirar que estás mojda o encharcado', 14.99, 350, 4, 1, 'img_690db22de21819.52888606.png', NULL, NULL, NULL, 'L', 'Negro', 'Malla'),
...
(42, 'Zinc y Magnesio', 'El zinc y el magnesio ofrecen numerosos beneficios para la salud, como fortalecer el sistema inmunitario y los huesos, reducir el cansancio y la fatiga, mejorar el rendimiento deportivo y la salud de la piel y el cabello.', 13.50, 500, 2, 0, 'img_6911cbec1d3876.06609641.png', 0, 0, 0, NULL, NULL, NULL),
(43, 'Omega 3', 'Los ácidos grasos omega-3 ofrecen beneficios para el entrenamiento de gimnasio, como la mejora de la recuperación muscular al reducir el dolor y la inflamación post-entrenamiento.', 13.99, 500, 2, 0, 'img_6911cc867174b8.13329808.png', 0, 0, 0, NULL, NULL, NULL),
(44, 'Aswhagandha', 'La ashwagandha es una planta medicinal adaptógena, que se utiliza para ayudar al cuerpo a adaptarse al estrés y a la ansiedad. Se usa para mejorar la calidad del sueño, la función cognitiva, el rendimiento deportivo y para fortalecer el sistema inmunológico.', 5.00, 450, 2, 0, 'img_6911cdbeb91737.85528436.png', 0, 0, 0, NULL, NULL, NULL),
(45, 'Gominolas de Creatina', 'Las gominolas de creatina son una perfecta opcion, en el caso de que no te guste la textura o el gusto de la creatina en polvo con una toma al día es suficiente para obtener tu dosis diaria!', 20.00, 400, 2, 1, 'img_6911d1d02ddc17.03222204.png', NULL, NULL, NULL, NULL, NULL, NULL),
(46, 'Gominolas de Magnesio', 'La manera mas facil de consumir magnesio!, con una dosis al dia podras tomar la dosis de magnesio diaria recomendada', 6.00, 450, 2, 0, 'img_6911d53bd74a29.79525823.png', NULL, NULL, NULL, NULL, NULL, NULL),
(47, 'Clear Whey Protein', 'La Clear Whey Protein es una proteina más ligera, por si la Whey normal no te sienta bien, de esta manera con una digestion mas ligera estarás cumpliendo tus objetivos sin ningún impedimento', 20.00, 300, 1, 0, 'img_6911d5d0c28cb3.65119341.png', 25, 10, 5, NULL, NULL, NULL),
(48, 'Straps', 'Los straps son un basico del gimnasio, te permite mejorar tu agarre y te permite focalizar el estimulo en el musculo que quieras entrenar', 5.99, 500, 5, 0, 'img_6911d9c78975c6.85183705.png', NULL, NULL, NULL, NULL, NULL, NULL),
(49, 'Cinturos Lumbar', 'El cinturon lumbar es una herramienta útil cuando tu entrenamiento pasa al siguiente nivel, cuando cargas altos pesos esta herramienta te ayudará a evitar lesiones', 25.00, 350, 5, 0, 'img_6911db3f292805.25128346.png', NULL, NULL, NULL, NULL, NULL, NULL),
(50, 'Guantes de gimnasio', 'Guantes básicos de entrenamiento para entrenar sin perder el estilo!', 9.99, 300, 5, 0, 'img_6911dc8870aa31.69596183.png', NULL, NULL, NULL, NULL, NULL, NULL),
(51, 'Cookie Proteica', 'Galleta proteica para ayudarte a dar un momento dulce sin perder tus objetivos de vista', 2.39, 400, 3, 0, 'img_6911df3099f996.52589940.png', 37, 19, 10, NULL, NULL, NULL),
(52, 'Saborizante sgua sandia', 'Estar bien hidratado es imprescindible, tanto por salud, como para poder rendir a nivel deportivo, por eso te facilitamos la tarea con nuestro saborizante sabor sandia sin calorias!', 5.99, 300, 3, 0, 'img_6911e041575be1.45822298.png', 0, 0, 0, NULL, NULL, NULL);
